...
//	virtual void print(float x, float y, const char * fmt, ...);
	...
	virtual void drawQuad(const Vector3f& pos, float w, float h, const Quaternion& rotation, const Color4f& color) const;
	...
	virtual void drawSphereT(const Vector3f& pos, const Quaternion& q, const float r, const Color4f& color, const std::string& texName) const;
